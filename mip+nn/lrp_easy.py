...
class createLRP ():
    ...
    def dataprocess(self,data_input_file):
        ...
        phi_loc='/Users/waquarkaleem/NEOS-LRP-Codes-1/pre_trained_model/model_phi_new.onnx'
        rho_loc='/Users/waquarkaleem/NEOS-LRP-Codes-1/pre_trained_model/model_rho_new.onnx'
